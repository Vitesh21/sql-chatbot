...
# Vanna AI 
vanna_api_key = "802b801d447d41869faab2b0add80497"
...
def query_database():
    ...
    if query is None:
        st.info("Note: You are connected to the Chinook sample database, which contains information about a digital media store (artists, albums, tracks, customers, etc.). Try asking questions about music, sales, or customers!")
